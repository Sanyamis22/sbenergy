...
const MonthlyReport = (props) => {
    ...
    const loader = useSelector((reduxState)=>{
        return reduxState.MonthlyReport.loader
    });


    const EmployeeList = useSelector((reduxState)=>{
        return reduxState.MonthlyReport.list
    })
    ...
    return(
        ...
        <TouchableOpacity onPress={()=> props.navigation.openDrawer()} style={{marginTop:5}}>
            ...
            <Text style={{fontSize:15, marginLeft:5, fontWeight:"bold"}}>Monthly Report</Text>
                ...
                <View style={styles.Shadowbox} key={i}>
                    <View style={styles.profile}>
                        ...
                        <View style={{paddingLeft:10}}>
                            <Text style={styles.name}>UserName : {row.userName}</Text>
                    ...
                    <View style={styles.description}>
                        <View style={styles.desc_part}>
                            <Text style={styles.label}>TotalHours</Text>
                        ...
                        <View style={styles.desc_part}>
                            ...
                            <Text style={styles.label_data}>{row.presentdays}</Text>
                        </View>
